---
title: "Bike Sharing Data Analysis Notebook"
author: N Plaunov
output:
  html_document:
    df_print: paged
...
```{r libraries_load, warning=FALSE, message=FALSE, }
library("tidyverse")
library("hms")
library("sf")
library("mapview")
...
```{r storing locations, message=FALSE}
...
```{r renaming columns, message=FALSE}
...
```{r normalizing values, message=FALSE}
...
```{r removing extra data columns, message=FALSE}
...
```{r merging data for two years, message=FALSE}
...
```{r adding calculated columns, message=FALSE}
...
```{r cleaning negative time trips, message=FALSE}
...
```{r removing way too long rides, message=FALSE}
...
```{r preparing data for graph, message=FALSE}
...
```{r graphing number of rides, message=FALSE}
...
```{r graphing rides durations, message=FALSE}
...
```{r graphing average ride duration, message=FALSE}
...
```{r preparing maps, message=FALSE}
...
```{r mapping casuals, message=FALSE, warning=FALSE}
...
```{r mapping members, message=FALSE, warning=FALSE}
...
```{r displaying same as table, message=FALSE, warning=FALSE}
